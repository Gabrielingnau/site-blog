    ...
    <section className="py-10 sm:py-20">
      <div className="mx-auto px-4 sm:px-6 max-w-screen-standard">
        <div className="w-full flex items-center justify-center">
          <h2 className="text-gray-100 md:text-xl text-md">
            Quem utiliza, aprova!
          </h2>
        </div>
        <div className="w-full flex flex-col md:flex-row gap-6 md:mt-12 mt-8">
          {customersStore.map((customerStore) => {
            return(
                <div className="w-auto p-10 flex flex-col items-start justify-center gap-10 bg-gray-600 rounded-xl">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div>
                <p className="text-gray-200 text-body-sm">{customerStore.author.name}</p>
